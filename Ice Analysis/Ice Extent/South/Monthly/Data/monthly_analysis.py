...
dataJanuary = pd.read_csv('S_01_extent_v3.0.csv', sep=",", usecols=[0,2,3,4,5], nrows=39, header=0)

#Discard missing entries
dataJanuary = dataJanuary.drop(dataJanuary[dataJanuary[" extent"] < -9000].index)

plot_extent("S_01_extent_v3.0.csv", "January")
plot_area("S_01_extent_v3.0.csv", "January")

plot_extent_variations("S_01_extent_v3.0.csv", "January")
plot_area_variations("S_01_extent_v3.0.csv", "January")
...
dataJune = pd.read_csv('S_06_extent_v3.0.csv', sep=",", usecols=[0,2,3,4,5], nrows=39, header=0)

#Discard missing entries
dataJune = dataJune.drop(dataJune[dataJune[" extent"] < -9000].index)

plot_extent("S_06_extent_v3.0.csv", "June")
plot_area("S_06_extent_v3.0.csv", "June")

plot_extent_variations("S_06_extent_v3.0.csv", "June")
plot_area_variations("S_06_extent_v3.0.csv", "June")
